...
func c2paReaderCrJson(unsafe.Pointer) string                                     { return "" }
...
func c2paReaderWithManifestDataAndStream(unsafe.Pointer, string, unsafe.Pointer, []byte) unsafe.Pointer {
	return nil
}
func c2paReaderWithFragment(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, string) unsafe.Pointer {
	return nil
}
...
func c2paBuilderAddIngredientFromStream(unsafe.Pointer, string, string, unsafe.Pointer) int {
	return -1
}
...
func c2paBuilderSign(unsafe.Pointer, string, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) ([]byte, int64) {
	return nil, -1
}
func c2paBuilderSignContext(unsafe.Pointer, string, unsafe.Pointer, unsafe.Pointer) ([]byte, int64) {
	return nil, -1
}
...
func c2paBuilderComposeManifest(unsafe.Pointer, string, []byte) ([]byte, int64)  { return nil, -1 }
...
func c2paIdentitySignerCreateWithCredentialHolder(unsafe.Pointer, string, uintptr, uintptr, []string, []string) unsafe.Pointer {
	return nil
}
