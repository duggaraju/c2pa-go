...
[![c2pa-rs](https://img.shields.io/badge/c2pa--rs-v0.90.14-orange?logo=rust)](https://github.com/contentauth/c2pa-rs)
...
The bindings track c2pa-rs `0.90.x` and link against the `c2pa_c` shared library
